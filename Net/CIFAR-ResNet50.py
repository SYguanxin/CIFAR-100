...
num_epochs = 50
lr = 0.05
params = torch.load('../ResNet-50.params')
# d2l.plt.ion()
train_ch6(net, train_iter, test_iter, num_epochs, lr=lr, device=cuda, params=params)
# d2l.plt.ioff()
d2l.plt.show()
...
if save == 'save':
    print('saving')
    torch.save(net.state_dict(), '../ResNet-50.params', )